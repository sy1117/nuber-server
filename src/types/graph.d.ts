...
export interface Mutation {
  CompletePhoneVerificationResponse: CompletePhoneVerificationResponse | null;
...
export interface CompletePhoneVerificationResponseMutationArgs {
  phoneNumber: string;
  key: string;
}
